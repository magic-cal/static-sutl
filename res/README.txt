...
Individual comps: 
Folders are named %COMPETION_NAME%%COMPETION_YEAR% for example: 'Southampton2019'

Resutls for competions are stored in these folders under the same format %COMPETION_NAME%%COMPETION_YEAR%.xls for example: 'Bath2018.xls'
...
These are stored in the comp folders for example: 'Southampton2019' and then there are different files to be dislayed:
